...
const getAppointmentsCount = () => {
    ...
    axios.get('/api/stats/appointments', {
        ...
        selectedAppointmentsCount.value = response.data.totalAppointmentsCount;
    })
}
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <div class="d-flex justify-content-between">
                                <h3>{{ selectedAppointmentsCount }}</h3>
                                <select v-model="selectedAppointmentSatatus"
                                    @change="getAppointmentsCount($event.target.value)"
